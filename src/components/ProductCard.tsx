    ...
    >
      <div className="relative overflow-hidden rounded-xl">
        ...
        <button 
          ...
          className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white text-gray-900 px-4 py-2 md:px-6 md:py-3 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0 flex items-center space-x-2 hover:bg-orange-500 hover:text-white text-sm md:text-base"
        >
      ...
      <div className="mt-4 md:mt-6 text-center px-2">
        <h3 className="text-base md:text-lg font-medium text-gray-900 line-clamp-1">{product.name}</h3>
        <p className="mt-1 md:mt-2 text-xs md:text-sm text-gray-500 line-clamp-2">{product.description}</p>
        {product.brand && (
